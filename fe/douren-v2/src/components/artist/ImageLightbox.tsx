          ...
          <div className="fixed inset-0 z-50 flex flex-col pointer-events-none">
            ...
            >
              <div className="flex flex-col gap-1">
                {artistName ? (
                  <h3
                    className="text-lg md:text-xl font-sans font-medium text-white dark:text-black"
                ...
                {images && currentIndex !== undefined ? (
                  <p className="text-xs md:text-sm font-mono text-white/80 dark:text-black/80">
              ...
              <button
                onClick={onClose}
                className="group p-2 rounded-sm bg-archive-bg/10 hover:bg-archive-bg/20 backdrop-blur-sm transition-all focus:outline-none focus:ring-2 focus:ring-archive-bg/50"
              ...
              <div className="relative pointer-events-none">
                {canNavigatePrev ? (
                  <motion.button
                    ...
                    onClick={(event) => {
                      ...
                      onNavigate?.((currentIndex ?? 1) - 1);
                    }}
                    className="pointer-events-auto absolute top-1/2 right-full -translate-x-6 md:-translate-x-10 -translate-y-1/2 p-3 md:p-4 rounded-sm bg-archive-bg hover:bg-archive-hover hover:[&>svg]:-translate-x-1 transition-all focus:outline-none focus:ring-2 focus:ring-archive-accent shadow-lg"
                    aria-label="Previous image"
                  >
                    <ChevronLeftIcon
                      size={24}
                      className="text-archive-text transition-transform duration-200"
                      strokeWidth={2.5}
                    />
                  </motion.button>
                ) : null}
                ...
                {canNavigateNext ? (
                  <motion.button
                    ...
                    className="pointer-events-auto absolute top-1/2 left-full translate-x-6 md:translate-x-10 -translate-y-1/2 p-3 md:p-4 rounded-sm bg-archive-bg hover:bg-archive-hover hover:[&>svg]:translate-x-1 transition-all focus:outline-none focus:ring-2 focus:ring-archive-accent shadow-lg"
            ...
            >
              <div className="flex items-center gap-6 px-5 py-2.5 rounded-sm bg-archive-bg shadow-lg">
                ...
                <div className="flex items-center gap-2">
                  <kbd className="px-2 py-0.5 text-[12px]! font-mono bg-archive-border/40 text-archive-text rounded border border-archive-border">
                    ESC
                  </kbd>
                  <span className="text-xs font-mono text-archive-text/70 ml-0.5">
                    Close
