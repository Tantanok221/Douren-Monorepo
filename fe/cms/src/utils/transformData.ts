import { ArtistFormSchema, EventArtistSchema } from '../components/EntityForm/schema'

// Transform database artist record to form schema
export function transformArtistToFormData(artistData: any): ArtistFormSchema | undefined {
...
export function transformEventArtistToFormData(eventArtistData: any): EventArtistSchema | undefined {
