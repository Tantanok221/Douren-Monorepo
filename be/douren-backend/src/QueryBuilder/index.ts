...
class ArtistQueryBuilder extends IQueryBuilder<ArtistFetchParams> {
  ...
  BuildQuery() {
    ...
    let SelectQuery = BuildQuery(query)
      .withOrderBy(this.derivedFetchParams.sortBy, this.derivedFetchParams.table)
    ...
    if (this.fetchParams.search) {
      SelectQuery.withIlikeSearchByTable(this.fetchParams.search, this.derivedFetchParams.searchTable);
      CountQuery.withIlikeSearchByTable(this.fetchParams.search, this.derivedFetchParams.searchTable);
    }
    return {
...
export function NewQueryBuilder(params: ArtistFetchParams | EventArtistFetchParams): EventArtistQueryBuilder | ArtistQueryBuilder {
