...
export const TagFilterContext = createContext<StoreApi<TagFilterStoreTypes> | null>(null)
...
export const TagFilterContextProvider = ({allFilter,children}: props) => {
 ...
 return <TagFilterContext.Provider value={store}>
   {children}
 </TagFilterContext.Provider>
}

const createTagFilterStore = (allFilter: TagObject[]) => createStore<TagFilterStoreTypes>()((set, get) => ({
  allFilter: allFilter,
  tagFilter: [],
