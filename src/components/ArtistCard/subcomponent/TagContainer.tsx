    ...
    <div className={sx("tagContainer")}>
      {renderTag.map((val, index) => {
        ...
        return (
          ...
          >
            <div className={sx("tagDescription", { activeTagCount: active }, { smallText : size === "s"})}>
              {val.tag}
            </div>
            <div className={sx("tagCount", { activeTagDescription: active }, { smallText : size === "s"})}>
              {val.count}
            </div>
          </motion.button>
        );
